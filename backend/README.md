...
## Project Structure
    ...
    ├── testapiautostorybo_106355  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_106355`
...
2. Clone this repo and `cd testapiautostorybo_106355`
